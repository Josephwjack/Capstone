...
function GetLocation() {
  ...
  async function GetData(call) {
    ...
    const url3 = (`https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/nearbysearch/json?types=restaurant&location=${lat3},${lng3}&radius=20000&key=${process.env.REACT_APP_API_KEY}`
      )
